...
config = from_file(r"C:\Users\Ohad\.oci\config", 'DEFAULT')
...
def modelResponse(filename):
    ...
    res = ai_vision_response.analyze_image(
    ...
    x = np.array([labels_results[0]['name'], labels_results[1]['name'], labels_results[2]
                ['name'], labels_results[3]['name'], labels_results[4]['name']])
    y = np.array([labels_results[0]['confidence'], labels_results[1]['confidence'], labels_results[2]
                ['confidence'], labels_results[3]['confidence'], labels_results[4]['confidence']])
